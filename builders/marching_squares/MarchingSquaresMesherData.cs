...
{
    public class MarchingSquaresMesherData : IDisposable
    {
        ...
        public MarchingSquaresMesherData(int col, int row, float[] defDistData = null, bool initHeights = false, float[] defHeightData = null, bool initCulling = false, bool[] defCullingData = null)
        {
